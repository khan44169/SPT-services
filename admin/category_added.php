...
if(isset($_POST['add_product'])){
   ...
   $select_products =mysqli_query($conn,"SELECT * FROM category WHERE category = '$name';");
   ...
   if(mysqli_num_rows($select_products)> 0){
      ...
      $insert_products = mysqli_query($conn,"INSERT INTO `category`(category, category_image) VALUES ('$name','$image_01')");
...
<section class="show-products">
   ...
   ?>
   <div class="box">
      <img src="../uploaded_img/<?= $fetch_products['category_image']; ?>" alt="">
