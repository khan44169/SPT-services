...
<div class="box-container">
   ...
   <p> Message : <span id="messageContent"><?= $fetch_message['message']; ?></span></p>
   <a href="messages.php??delete=<?= $fetch_message['id']; ?>" onclick="return confirm('delete this message?');"  id="messageDelBtn">delete</a>
   </div>
   <?php
         }
      }else{
